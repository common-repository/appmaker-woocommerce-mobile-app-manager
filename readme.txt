...
Updated Date: 28/07/22

* Added new API for related products
* WooCommerce Plugin:Translatepress language code issue fix
* Minor bug fixes
...
* Added an option for users to delete their account on Myaccount page
* Added subcategories filter

= 1.36.6 =

Updated Date: 06/06/22

* Order notes bug fixes
...
Updated Date: 09/05/22

* Outofstock products on scrollers issue fix
* Added Post grid, post scroller, product grid widgets
* WooCommerce Plugin: Dokan  conflicts with google login fixes
* Other minor bug fixes

= 1.36.3 =

Updated Date: 17/02/22

* WooCommerce Plugin: Fibosearch plugin fixes
* Performance optimization
* WooCommerce Plugin: Miniorange OTP plugin conflict fixes
* Other minor bug fixes

= 1.36.2 =

Updated Date: 24/01/22

* WooCommerce Plugin: Sumo Payment Plans plugin bug fixes
* WooCommerce Plugin: Aftership plugin 1.14 compatibility fixes
* Report Product Comments feature
* Direct Bank Transfer gateway fixes
* WooCommerce Plugin: Dokan Pro chat feature fixes
* WooCommerce Plugin: Translatepress plugin bug fixes
* Compatible with WooCommerce 6.1

= 1.36.1 =

Updated Date: 21/12/21

* WooCommerce Plugin: Composite plugin cart issues fix
* Resolved issue with Product variations with any attributes option
* Vcb gateway redirection fixes
* Recent products result fixes
