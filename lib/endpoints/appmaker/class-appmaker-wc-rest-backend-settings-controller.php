				...
				'fields' => array(
					...
					self::get_field(
						array(
							...
							'label'       => 'Attributes to be displayed on the product list page',
							'default'     => array(),
							'multi'       => true,
							'data_source' => array(
								'data' => $this->get_product_filter_settings(),
			...
			'advanced'            => array(
				...
				'fields' => array(
					...
					self::get_field(
						array(
							'type'        => 'select',
							'id'          => 'allow_visitors_to_report_comments',
							'label'       => 'Allow visitors to report comments',
							'default'     => 1,
							'data_source' => array(
								'data' => array(
									array(
					...
					self::get_field(
						array(
							'type'        => 'select',
							'id'          => 'remove_delete_account_menu',
							'label'       => 'Remove Delete Account menu from myaccount page',
							'default'     => 0,
							'data_source' => array(
								'data' => array(
									array(
